...
def test_load_checked_in_metrics_config() -> None:
    ...
    assert cfg.size_ladder_usd == [1000, 5000, 20000]
    assert cfg.bybit_taker_fee_bps == 10
    assert cfg.usdt_usdc_basis_bps == 0
    assert cfg.gas_usd_per_swap == 0.01
    assert cfg.breach_size_usd == 1000
