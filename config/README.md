...
| `collector.yaml` | `monitor.collector.load_collector_config` | Live collector tunables (Bybit WS, Mantle poll, RFQ notional, SQLite path, **retention / disk waterline** — WHI-751) — M2 / WHI-731. |
