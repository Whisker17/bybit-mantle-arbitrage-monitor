...
class SpreadPoint:
    ...
    ``amm_spread_bps`` is (AMM mid − Bybit mid) / Bybit in bps (DEX vs CEX).
    ...
    Premium fields (WHI-779 / WHI-783) are equity-eq venue mid vs underlying:
    CEX / AMM / RFQ; None when no as-of underlying print.
    """
