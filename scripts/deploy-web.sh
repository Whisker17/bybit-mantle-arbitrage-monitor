...
echo "    note: collectors are NOT restarted (long-lived processes)."
echo "          After collector/underlying code changes, on the host run:"
echo "            sudo systemctl restart xstocks-collector@bybit-fluxion"
echo "            sudo systemctl restart xstocks-collector@binance-pancake  # if enabled"
echo "          See deploy/README.md § Restart collectors after collector code ships."
